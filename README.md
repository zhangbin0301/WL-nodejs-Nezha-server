...
1.设置变量UUID可开启自带节点，否则不开启，支持vless和vmess协议

节点信息查看日志，复制节点链接即可

2.设置变量IS_UPDATE值为yes，可自动升级服务端，默认不升级

3.变量AGENT_VER=0.20.5，哪吒客户端版本，默认v0.17.5

4.变量DASH_VER=0.20.13，哪吒服务端版本,默认v0.17.9
